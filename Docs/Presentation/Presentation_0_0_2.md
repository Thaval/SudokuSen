...
You can now choose a specific difficulty for Challenge modes (Auto, Easy, Medium, Hard). When set to "Auto", the game recommends a difficulty based on your play history and win rate.

### Tooltips Everywhere
All buttons and settings now have helpful tooltips – hover over any element to learn what it does!

### Dynamic UI Scaling
The UI scale slider now adapts to your screen resolution, showing valid min/max values and preventing unusable scaling.

### Background Click to Deselect
Click anywhere outside the grid to clear your cell selection.
...
![Main Menu](screenshots/0.0.2/HomeScreen.png)

*The main menu – hover over buttons to see tooltips explaining each option.*
...
**New in v0.0.2:** All buttons now show tooltips when you hover over them!
...
![Difficulty Selection](screenshots/0.0.2/SelectDifficulty.png)
...
![9x9 Game Screen](screenshots/0.0.2/9x9Ingame.png)
...
![Grid Controls](screenshots/0.0.2/GridControls.png)
...
![Cell Highlighting](screenshots/0.0.2/IngameHighlightDigitsRowsAndCols.png)

*When you select a cell, related cells are highlighted to help you spot patterns.*

**New in v0.0.2:** Click outside the grid to clear your selection!
...
![Grid with Labels](screenshots/0.0.2/GridLabels.png)
...
![Kids Mode](screenshots/0.0.2/KidsIngame.png)
...
![Adding Notes](screenshots/0.0.2/IngameAddNote.png)

*In notes mode, clicking numbers adds small candidate markers instead of filling the cell.*

![Notes Display](screenshots/0.0.2/IngameShowNotes.png)
...
![Row/Column/Block Toggle](screenshots/0.0.2/RowColBlockNoteToggle.png)
...
### New: Challenge Difficulty (v0.0.2)

You can now set a specific difficulty for Challenge games:

| Setting | Behavior |
|---------|----------|
| **Auto** | Recommends difficulty based on your win rate and mistake average |
| **Leicht** | Always starts on Easy |
| **Mittel** | Always starts on Medium |
| **Schwer** | Always starts on Hard |

When Challenge mode is active with a set difficulty, clicking "Neues Spiel" skips the difficulty selection screen.
...
![Statistics Screen](screenshots/0.0.2/Statistics.png)
...
![History Screen](screenshots/0.0.2/History.png)
...
![Settings Screen](screenshots/0.0.2/Settings.png)

*The settings menu – all options now show tooltips when hovered!*
...
| **UI-Skalierung** | Adjust interface size for your screen (dynamic range based on resolution) |
...
| **Challenge Difficulty** | Set difficulty for Challenge modes (Auto/Easy/Medium/Hard) |
| **Challenge Modes** | Enable/disable various challenges |

**New in v0.0.2:** The UI scale slider now shows the valid range for your screen resolution!
...
![Tips Menu](screenshots/0.0.2/TipsMenu.png)
...
Adjust **UI-Skalierung** in Settings to scale the interface. The slider now shows the valid range for your screen resolution.

### Challenge mode isn't using the difficulty I set

Challenge Difficulty only affects new games. If you already have a game in progress, start a new one.
